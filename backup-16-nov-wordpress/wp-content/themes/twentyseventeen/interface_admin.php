...
<script>
function getEvent() {
  var evenement = document.getElementById("selectEvent");
...
<body>
  <div class="formulaire">
    ...
    <div class=" form-group col-12" >
      <a href="?page_id=738">
        <input type="button"  class="btn btn-dark col-xs-12 col-sm-12 col-md-6 col-lg-4" value="Affichage de la base de données" onclick="getEvent()" />
      </a>
    </div>
    <div class=" form-group col-12" >
      <a href="?page_id=750">
